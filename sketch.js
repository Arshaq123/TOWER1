...
function setup() {
  ...
  b1 = new Block(900,105,30,40);
  b2 = new Block(900,185,30,40);
  b3 = new Block(870,185,30,40);
  b4 = new Block(930,185,30,40);
  b5 = new Block(900,155,30,40);
  b6 = new Block(870,155,30,40);
  b7 = new Block(840,155,30,40);
  b8 = new Block(930,155,30,40);
  b9 = new Block(960,155,30,40);
